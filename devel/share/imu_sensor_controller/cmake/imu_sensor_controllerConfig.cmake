...
if("TRUE" STREQUAL "TRUE")
  set(imu_sensor_controller_SOURCE_PREFIX /workspace/src/ros_controllers/imu_sensor_controller)
  set(imu_sensor_controller_DEVEL_PREFIX /workspace/devel)
  ...
  set(imu_sensor_controller_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/src/ros_controllers/imu_sensor_controller/include " STREQUAL " ")
  set(imu_sensor_controller_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/src/ros_controllers/imu_sensor_controller/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_sensor_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/ros_controllers/imu_sensor_controller/${idir}'.  ${_report}")
    endif()
