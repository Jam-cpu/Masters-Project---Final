...
if("TRUE" STREQUAL "TRUE")
  set(rcomponent_SOURCE_PREFIX /workspace/src/rcomponent)
  set(rcomponent_DEVEL_PREFIX /workspace/devel)
  ...
  set(rcomponent_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/src/rcomponent/include " STREQUAL " ")
  set(rcomponent_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/src/rcomponent/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rcomponent' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/rcomponent/${idir}'.  ${_report}")
    endif()
