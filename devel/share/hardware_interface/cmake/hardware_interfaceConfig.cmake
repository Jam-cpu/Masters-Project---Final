...
if("TRUE" STREQUAL "TRUE")
  set(hardware_interface_SOURCE_PREFIX /workspace/src/ros_control/hardware_interface)
  set(hardware_interface_DEVEL_PREFIX /workspace/devel)
  ...
  set(hardware_interface_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/src/ros_control/hardware_interface/include " STREQUAL " ")
  set(hardware_interface_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/src/ros_control/hardware_interface/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hardware_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/ros_control/hardware_interface/${idir}'.  ${_report}")
    endif()
