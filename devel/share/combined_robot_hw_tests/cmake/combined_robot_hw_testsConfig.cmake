...
if("TRUE" STREQUAL "TRUE")
  set(combined_robot_hw_tests_SOURCE_PREFIX /workspace/src/ros_control/combined_robot_hw_tests)
  set(combined_robot_hw_tests_DEVEL_PREFIX /workspace/devel)
  ...
  set(combined_robot_hw_tests_INSTALL_PREFIX /workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'combined_robot_hw_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/ros_control/combined_robot_hw_tests/${idir}'.  ${_report}")
    endif()
