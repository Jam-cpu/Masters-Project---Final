...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_SOURCE_PREFIX /workspace/src/ros_control/controller_manager)
  set(controller_manager_DEVEL_PREFIX /workspace/devel)
  ...
  set(controller_manager_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/src/ros_control/controller_manager/include " STREQUAL " ")
  set(controller_manager_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/src/ros_control/controller_manager/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/ros_control/controller_manager/${idir}'.  ${_report}")
    endif()
