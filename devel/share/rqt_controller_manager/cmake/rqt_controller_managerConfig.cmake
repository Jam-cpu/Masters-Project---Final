...
if("TRUE" STREQUAL "TRUE")
  set(rqt_controller_manager_SOURCE_PREFIX /workspace/src/ros_control/rqt_controller_manager)
  set(rqt_controller_manager_DEVEL_PREFIX /workspace/devel)
  ...
  set(rqt_controller_manager_INSTALL_PREFIX /workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/ros_control/rqt_controller_manager/${idir}'.  ${_report}")
    endif()
