...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_msgs_SOURCE_PREFIX /workspace/src/ros_control/controller_manager_msgs)
  set(controller_manager_msgs_DEVEL_PREFIX /workspace/devel)
  ...
  set(controller_manager_msgs_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/ros_control/controller_manager_msgs/${idir}'.  ${_report}")
    endif()
