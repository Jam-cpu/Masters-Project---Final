...
if("TRUE" STREQUAL "TRUE")
  set(diff_drive_controller_SOURCE_PREFIX /workspace/src/ros_controllers/diff_drive_controller)
  set(diff_drive_controller_DEVEL_PREFIX /workspace/devel)
  ...
  set(diff_drive_controller_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/devel/include;/workspace/src/ros_controllers/diff_drive_controller/include;/usr/include " STREQUAL " ")
  set(diff_drive_controller_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/devel/include;/workspace/src/ros_controllers/diff_drive_controller/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/ros_controllers/diff_drive_controller/${idir}'.  ${_report}")
    endif()
