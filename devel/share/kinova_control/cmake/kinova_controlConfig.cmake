...
if("TRUE" STREQUAL "TRUE")
  set(kinova_control_SOURCE_PREFIX /workspace/src/kinova-ros/kinova_control)
  set(kinova_control_DEVEL_PREFIX /workspace/devel)
  ...
  set(kinova_control_INSTALL_PREFIX /workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kinova_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/kinova-ros/kinova_control/${idir}'.  ${_report}")
    endif()
