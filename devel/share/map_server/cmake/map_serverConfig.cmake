...
if("TRUE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /workspace/src/navigation/map_server)
  set(map_server_DEVEL_PREFIX /workspace/devel)
  ...
  set(map_server_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/src/navigation/map_server/include " STREQUAL " ")
  set(map_server_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/src/navigation/map_server/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/navigation/map_server/${idir}'.  ${_report}")
    endif()
