...
if("TRUE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /workspace/src/robot_localization)
  set(robot_localization_DEVEL_PREFIX /workspace/devel)
  ...
  set(robot_localization_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/devel/include;/workspace/src/robot_localization/include;/usr/include/eigen3 " STREQUAL " ")
  set(robot_localization_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/devel/include;/workspace/src/robot_localization/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/robot_localization/${idir}'.  ${_report}")
    endif()
