...
if("TRUE" STREQUAL "TRUE")
  set(velocity_controllers_SOURCE_PREFIX /workspace/src/ros_controllers/velocity_controllers)
  set(velocity_controllers_DEVEL_PREFIX /workspace/devel)
  ...
  set(velocity_controllers_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/src/ros_controllers/velocity_controllers/include " STREQUAL " ")
  set(velocity_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/src/ros_controllers/velocity_controllers/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velocity_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/ros_controllers/velocity_controllers/${idir}'.  ${_report}")
    endif()
