...
if("TRUE" STREQUAL "TRUE")
  set(rotate_recovery_SOURCE_PREFIX /workspace/src/navigation/rotate_recovery)
  set(rotate_recovery_DEVEL_PREFIX /workspace/devel)
  ...
  set(rotate_recovery_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/src/navigation/rotate_recovery/include " STREQUAL " ")
  set(rotate_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/src/navigation/rotate_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotate_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/navigation/rotate_recovery/${idir}'.  ${_report}")
    endif()
