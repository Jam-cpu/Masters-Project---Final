// Generated by gencpp from file interbotix_xsarm_joy/ArmJoy.msg
// DO NOT EDIT!


#ifndef INTERBOTIX_XSARM_JOY_MESSAGE_ARMJOY_H
#define INTERBOTIX_XSARM_JOY_MESSAGE_ARMJOY_H
...
namespace interbotix_xsarm_joy
{
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> const> ConstPtr;

}; // struct ArmJoy_

typedef ::interbotix_xsarm_joy::ArmJoy_<std::allocator<void> > ArmJoy;

typedef boost::shared_ptr< ::interbotix_xsarm_joy::ArmJoy > ArmJoyPtr;
typedef boost::shared_ptr< ::interbotix_xsarm_joy::ArmJoy const> ArmJoyConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator1> & lhs, const ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> >
{
  ...
  static const char* value(const ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x09eb0cc37cce12e4ULL;
  static const uint64_t static_value2 = 0x1a0f984f2c2f53cdULL;
};

template<class ContainerAllocator>
struct DataType< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> >
{
  static const char* value()
  {
    return "interbotix_xsarm_joy/ArmJoy";
  }
...
template<class ContainerAllocator>
struct Definition< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Send commands from the xsarm_joy node to the xsarm_robot node\n"
"\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::interbotix_xsarm_joy::ArmJoy_<ContainerAllocator>& v)
  {
    s << indent << "ee_x_cmd: ";
...
#endif // INTERBOTIX_XSARM_JOY_MESSAGE_ARMJOY_H
