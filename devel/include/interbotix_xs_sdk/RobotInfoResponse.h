// Generated by gencpp from file interbotix_xs_sdk/RobotInfoResponse.msg
// DO NOT EDIT!


#ifndef INTERBOTIX_XS_SDK_MESSAGE_ROBOTINFORESPONSE_H
#define INTERBOTIX_XS_SDK_MESSAGE_ROBOTINFORESPONSE_H
...
struct RobotInfoResponse_
{
  ...
  typedef boost::shared_ptr< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> const> ConstPtr;

}; // struct RobotInfoResponse_

typedef ::interbotix_xs_sdk::RobotInfoResponse_<std::allocator<void> > RobotInfoResponse;

typedef boost::shared_ptr< ::interbotix_xs_sdk::RobotInfoResponse > RobotInfoResponsePtr;
typedef boost::shared_ptr< ::interbotix_xs_sdk::RobotInfoResponse const> RobotInfoResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator1> & lhs, const ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xaab05469cfeca32cULL;
  static const uint64_t static_value2 = 0xe718e0ba473d9ba5ULL;
};

template<class ContainerAllocator>
struct DataType< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::interbotix_xs_sdk::RobotInfoResponse_<ContainerAllocator>& v)
  {
    s << indent << "mode: ";
...
#endif // INTERBOTIX_XS_SDK_MESSAGE_ROBOTINFORESPONSE_H
