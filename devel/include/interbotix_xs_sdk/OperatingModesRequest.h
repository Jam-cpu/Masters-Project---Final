// Generated by gencpp from file interbotix_xs_sdk/OperatingModesRequest.msg
// DO NOT EDIT!


#ifndef INTERBOTIX_XS_SDK_MESSAGE_OPERATINGMODESREQUEST_H
#define INTERBOTIX_XS_SDK_MESSAGE_OPERATINGMODESREQUEST_H
...
struct OperatingModesRequest_
{
  ...
  typedef boost::shared_ptr< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> const> ConstPtr;

}; // struct OperatingModesRequest_

typedef ::interbotix_xs_sdk::OperatingModesRequest_<std::allocator<void> > OperatingModesRequest;

typedef boost::shared_ptr< ::interbotix_xs_sdk::OperatingModesRequest > OperatingModesRequestPtr;
typedef boost::shared_ptr< ::interbotix_xs_sdk::OperatingModesRequest const> OperatingModesRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator1> & lhs, const ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xcb68bef3d517c840ULL;
  static const uint64_t static_value2 = 0xb0a5cc0f73d64e36ULL;
};

template<class ContainerAllocator>
struct DataType< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::interbotix_xs_sdk::OperatingModesRequest_<ContainerAllocator>& v)
  {
    s << indent << "cmd_type: ";
...
#endif // INTERBOTIX_XS_SDK_MESSAGE_OPERATINGMODESREQUEST_H
