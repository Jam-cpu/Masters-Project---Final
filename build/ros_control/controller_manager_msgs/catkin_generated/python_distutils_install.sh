...
echo_and_run cd "/workspace/src/ros_control/controller_manager_msgs"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /workspace/build/ros_control/controller_manager_msgs \
    build --build-base "/workspace/build/ros_control/controller_manager_msgs" \
    install \
    --root="${DESTDIR-/}" \
