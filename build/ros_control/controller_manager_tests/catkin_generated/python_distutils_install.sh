...
echo_and_run cd "/workspace/src/ros_control/controller_manager_tests"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /workspace/build/ros_control/controller_manager_tests \
    build --build-base "/workspace/build/ros_control/controller_manager_tests" \
    install \
    --root="${DESTDIR-/}" \
