...
echo_and_run cd "/workspace/src/ros_control/controller_manager"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /workspace/build/ros_control/controller_manager \
    build --build-base "/workspace/build/ros_control/controller_manager" \
    install \
    --root="${DESTDIR-/}" \
