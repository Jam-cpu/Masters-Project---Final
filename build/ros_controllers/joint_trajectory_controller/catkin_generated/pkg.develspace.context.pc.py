...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/src/ros_controllers/joint_trajectory_controller/include;/usr/include".split(';') if "/workspace/src/ros_controllers/joint_trajectory_controller/include;/usr/include" != "" else []
