...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/src/ros_controllers/joint_state_controller/include".split(';') if "/workspace/src/ros_controllers/joint_state_controller/include" != "" else []
