...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/src/ros_controllers/imu_sensor_controller/include".split(';') if "/workspace/src/ros_controllers/imu_sensor_controller/include" != "" else []
