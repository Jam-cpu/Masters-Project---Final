...
echo_and_run cd "/workspace/src/ros_controllers/rqt_joint_trajectory_controller"
...
echo_and_run /usr/bin/env \
    ...
    "/workspace/src/ros_controllers/rqt_joint_trajectory_controller/setup.py" \
     \
    build --build-base "/workspace/build/ros_controllers/rqt_joint_trajectory_controller" \
    install \
    --root="${DESTDIR-/}" \
