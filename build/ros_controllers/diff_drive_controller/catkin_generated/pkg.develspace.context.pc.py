...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/devel/include;/workspace/src/ros_controllers/diff_drive_controller/include;/usr/include".split(';') if "/workspace/devel/include;/workspace/src/ros_controllers/diff_drive_controller/include;/usr/include" != "" else []
