...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/src/ros_controllers/four_wheel_steering_controller/include;/usr/include".split(';') if "/workspace/src/ros_controllers/four_wheel_steering_controller/include;/usr/include" != "" else []
