...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/src/openslam_gmapping/include;/workspace/devel/include".split(';') if "/workspace/src/openslam_gmapping/include;/workspace/devel/include" != "" else []
