...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/devel/include;/workspace/src/robot_localization/include;/usr/include/eigen3".split(';') if "/workspace/devel/include;/workspace/src/robot_localization/include;/usr/include/eigen3" != "" else []
