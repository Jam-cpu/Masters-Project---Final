...
get_filename_component(_filename "/workspace/src/robot_localization/srv/SetUTMZone.srv" NAME_WE)
add_custom_target(_robot_localization_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_localization" "/workspace/src/robot_localization/srv/SetUTMZone.srv" ""
)

get_filename_component(_filename "/workspace/src/robot_localization/srv/SetDatum.srv" NAME_WE)
add_custom_target(_robot_localization_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_localization" "/workspace/src/robot_localization/srv/SetDatum.srv" "geographic_msgs/GeoPose:geographic_msgs/GeoPoint:geometry_msgs/Quaternion"
)

get_filename_component(_filename "/workspace/src/robot_localization/srv/ToLL.srv" NAME_WE)
add_custom_target(_robot_localization_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_localization" "/workspace/src/robot_localization/srv/ToLL.srv" "geographic_msgs/GeoPoint:geometry_msgs/Point"
)

get_filename_component(_filename "/workspace/src/robot_localization/srv/FromLL.srv" NAME_WE)
add_custom_target(_robot_localization_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_localization" "/workspace/src/robot_localization/srv/FromLL.srv" "geographic_msgs/GeoPoint:geometry_msgs/Point"
)

get_filename_component(_filename "/workspace/src/robot_localization/srv/ToggleFilterProcessing.srv" NAME_WE)
add_custom_target(_robot_localization_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_localization" "/workspace/src/robot_localization/srv/ToggleFilterProcessing.srv" ""
)

get_filename_component(_filename "/workspace/src/robot_localization/srv/SetPose.srv" NAME_WE)
add_custom_target(_robot_localization_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_localization" "/workspace/src/robot_localization/srv/SetPose.srv" "geometry_msgs/PoseWithCovarianceStamped:geometry_msgs/Pose:geometry_msgs/PoseWithCovariance:std_msgs/Header:geometry_msgs/Quaternion:geometry_msgs/Point"
)

get_filename_component(_filename "/workspace/src/robot_localization/srv/GetState.srv" NAME_WE)
add_custom_target(_robot_localization_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_localization" "/workspace/src/robot_localization/srv/GetState.srv" ""
)
...
_generate_srv_cpp(robot_localization
  ...
  "${MSG_I_FLAGS}"
  "/workspace/src/geographic_info/geographic_msgs/msg/GeoPose.msg;/workspace/src/geographic_info/geographic_msgs/msg/GeoPoint.msg;/opt/ros/melodic/share/geometry_msgs/cmake/../msg/Quaternion.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/robot_localization
)
_generate_srv_cpp(robot_localization
  "/workspace/src/robot_localization/srv/ToLL.srv"
  "${MSG_I_FLAGS}"
  "/workspace/src/geographic_info/geographic_msgs/msg/GeoPoint.msg;/opt/ros/melodic/share/geometry_msgs/cmake/../msg/Point.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/robot_localization
)
_generate_srv_cpp(robot_localization
