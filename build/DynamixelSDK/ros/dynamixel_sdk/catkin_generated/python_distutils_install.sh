...
echo_and_run cd "/workspace/src/DynamixelSDK/ros/dynamixel_sdk"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/workspace/src/DynamixelSDK/ros/dynamixel_sdk/setup.py" \
     \
    build --build-base "/workspace/build/DynamixelSDK/ros/dynamixel_sdk" \
    install \
    --root="${DESTDIR-/}" \
