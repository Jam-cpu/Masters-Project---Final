...
echo_and_run cd "/workspace/src/geographic_info/geodesy"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /workspace/build/geographic_info/geodesy \
    build --build-base "/workspace/build/geographic_info/geodesy" \
    install \
    --root="${DESTDIR-/}" \
