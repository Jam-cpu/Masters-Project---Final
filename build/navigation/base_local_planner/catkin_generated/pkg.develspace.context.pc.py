...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/devel/include;/workspace/src/navigation/base_local_planner/include".split(';') if "/workspace/devel/include;/workspace/src/navigation/base_local_planner/include" != "" else []
