...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/devel/include;/workspace/src/navigation/amcl/include".split(';') if "/workspace/devel/include;/workspace/src/navigation/amcl/include" != "" else []
