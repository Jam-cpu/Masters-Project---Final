...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/devel/include;/workspace/src/navigation/global_planner/include".split(';') if "/workspace/devel/include;/workspace/src/navigation/global_planner/include" != "" else []
