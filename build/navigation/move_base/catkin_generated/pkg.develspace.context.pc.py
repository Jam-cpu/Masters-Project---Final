...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/devel/include;/workspace/src/navigation/move_base/include;/usr/include/eigen3".split(';') if "/workspace/devel/include;/workspace/src/navigation/move_base/include;/usr/include/eigen3" != "" else []
