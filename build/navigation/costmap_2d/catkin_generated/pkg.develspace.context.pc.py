...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/devel/include;/workspace/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include".split(';') if "/workspace/devel/include;/workspace/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include" != "" else []
