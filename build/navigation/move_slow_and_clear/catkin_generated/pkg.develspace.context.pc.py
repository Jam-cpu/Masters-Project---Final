...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/src/navigation/move_slow_and_clear/include".split(';') if "/workspace/src/navigation/move_slow_and_clear/include" != "" else []
